	...
	<header id="masthead" class="site-header" role="banner">
		...
		// test for Polylang language	
			...
			if ( $current_locale == 'fr' ) {
			    	...
			    	?>
			    	<a href="http://libregraphicsmeeting.org/2015/fr/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/lgm2015-header-fr.png" class="header-image" width="960" height="250" alt="Libre Graphics Meeting 2015: Beyond the First Decade" /></a>
			    	<?php
